...
class tEnvoy {
  ...
  fixArmor(armored) {
	  ...
	  return armored.replace("Version: OpenPGP.js v4.10.10", "Version: " + v).replace("Comment: https://openpgpjs.org", "Comment: https://togatech.org/ (Key generated by TogaTech tEnvoy)");
  }
  randomString(args) {
    if(args == null) {
      args = {};
...
window.TogaTech.tEnvoy = new tEnvoy(window.openpgp);
